...
from screens.inv_mgnt_screen import InvMgntScreen
...
class CapyTUI(App):
    ...
    def __init__(self):
        super().__init__()
        self.db = Database()
        self.install_screen("inv-mgnt", InvMgntScreen(self.db))
